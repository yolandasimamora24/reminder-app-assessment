...
<head>
    ...
    <style type="text/css">
        ...
        @media (max-width: 480px) {
            ...
            .cta-btn-left.v-container-padding-padding {
                padding: 10px 5px 30px 20px !important;
            }

            .cta-btn-right.v-container-padding-padding {
...
<body class="clean-body u_body"
    style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #0090BA;color: #000000">
    <!--[if IE]><div class="ie-container"><![endif]-->
    <!--[if mso]><div class="mso-container"><![endif]-->
    <table
        style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #0090BA;width:100%"
        cellpadding="0" cellspacing="0">
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: #0090BA;"><![endif]-->
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 550px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #ffffff; border-radius: 5px;-webkit-border-radius: 20px; overflow: hidden; -moz-border-radius: 5px;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                                <div class="u-col u-col-100"
                                    style="max-width: 320px;min-width: 550px;display: table-cell;vertical-align: top;">
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_1"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word; font-family:arial,helvetica,sans-serif; border-radius: 30px;"
                                                            align="left">

                                                            <div class="v-text-align"
                                                                style="color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                               <div style="line-height: initial; padding: 0 30px 50px;">
                                                                    <h1>Hi {{ $name }},</h1>
                                                                    <p>You recently requested to reset your password for
                                                                        your account. Use the button below
                                                                        to reset it. <strong>
                                                                    ...
                                                                    <span style="text-align: center; display: block;">
                                                                        <a href="{{ $url }}"
                                                                            style="display: inline-block; background: linear-gradient(90deg, #D81488 0%, #F58148 100%); padding: 22px 40px; line-height: 1; color: #fff; border-radius: 30px; margin: auto;">Reset
                                                                    ...
                                                                    <table class="body-sub" role="presentation">
                                                                        <tr>
                                                                            <td>
                                                                                <p class="f-fallback sub">If you’re
                                                                                    having trouble with the button
                                                                                    above, copy and paste the URL below
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <table height="0px" align="center" border="0"
                                                                ...
                                                                <tbody>
                                                                    <tr style="vertical-align: top">
                                                                        <td
                                                                            style="text-align:center;color:#fff;word-break: break-word;border-collapse: collapse !important;vertical-align: top;font-size: 16px;line-height: 20px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                                            <b></b>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="vertical-align: top">
                                                                        <td
                                                                            style="text-align:center;color:#fff;word-break: break-word;border-collapse: collapse !important;vertical-align: top;font-size: 12px;line-height: 20px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                                            <span>1178 Broadway, New York, NY,
                                                                                10001</span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="vertical-align: top">
                                                                        <td
                                                                            style="text-align:center;color:rgba(255,255,255, 0.75);word-break: break-word;border-collapse: collapse !important;vertical-align: top;font-size: 12px;line-height: 20px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
