...
class CheckIfAdmin
{
    ...
    {
        return User::whereEmail($user->email)->where(function ($query) {
                    $query->whereNotNull('user_type')->whereNotIn('user_type', ['patient', 'dependent']);
                })->exists();
    }
    ...
    private function respondToUnauthorizedRequest($request)
    {
        ...
        if ($request->ajax() || $request->wantsJson()) {
            ...
            Alert::error("You are not authorized to login to this portal.")->flash();
